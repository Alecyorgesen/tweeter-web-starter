      ...
      <div className="form-main w-100 m-auto rounded">
        <form>
          ...
          <div className="text-center mb-3">
            <OAuth
              icon={["fab", "google"]}
              displayMessage="Google registration is not implemented."
              tooltipID="googleTooltip"
              tooltipText="Google"
            />
            <OAuth
              icon={["fab", "facebook"]}
              displayMessage="Facebook registration is not implemented."
              tooltipID="facebookTooltip"
              tooltipText="Facebook"
            />
            <OAuth
              icon={["fab", "twitter"]}
              displayMessage="Twitter registration is not implemented."
              tooltipID="twitterTooltip"
              tooltipText="Twitter"
            />
            <OAuth
              icon={["fab", "linkedin"]}
              displayMessage="LinkedIn registration is not implemented."
              tooltipID="linkedInTooltip"
              tooltipText="LinkedIn"
            />
            <OAuth
              icon={["fab", "github"]}
              displayMessage="Github registration is not implemented."
